...
export default function AgentDetail({ id }: Props) {
  ...
  if (loading) return <div style={{ color: "#9992b8", padding: 40 }}>Carregando...</div>;
  if (!agent) return <div style={{ color: "#f87171", padding: 40 }}>Agente não encontrado</div>;

  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
        <button onClick={() => navigate("/app/agents")} style={{ background: "transparent", border: "none", color: "#9992b8", fontSize: 22, cursor: "pointer", lineHeight: 1 }}>←</button>
        <div>
        ...
        <div style={{ maxWidth: 600 }}>
          <Card>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ fontSize: 12, color: "#9992b8", marginBottom: 8 }}>Defina como o agente deve se comportar, qual o tom de voz, limitações, etc.</p>
              <textarea
        ...
        <div style={{ maxWidth: 700 }}>
          ...
          {(agent.knowledge ?? []).length === 0 && !addingK ? (
            <div style={{ textAlign: "center", padding: "60px 0" }}>
              ...
              <p style={{ color: "#9992b8" }}>Nenhum documento adicionado ainda</p>
            </div>
          ) : (
          ...
          <Card>
            ...
            {whatsappStatus.status === "qr" && whatsappStatus.qr && (
              <div style={{ textAlign: "center", marginBottom: 24 }}>
                ...
                <div style={{ display: "inline-block", padding: 16, background: "#fff", borderRadius: 16, boxShadow: "0 0 40px rgba(139,92,246,0.2)" }}>
            ...
            <div style={{ marginTop: 24, padding: 16, borderRadius: 10, background: "rgba(139,92,246,0.05)", border: "1px solid rgba(139,92,246,0.1)" }}>
              <p style={{ fontSize: 13, color: "#9992b8", lineHeight: 1.7 }}>
...
const btnGhost: React.CSSProperties = {
  padding: "11px 24px", background: "transparent", border: "1px solid rgba(139,92,246,0.12)",
