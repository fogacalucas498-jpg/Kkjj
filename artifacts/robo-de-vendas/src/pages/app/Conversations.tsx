      ...
      {loading ? (
        ...
        <div style={{ textAlign: "center", padding: "80px 0" }}>
          ...
          <Link href="/app/agents">
            <button style={{ marginTop: 16, padding: "11px 24px", background: "linear-gradient(135deg, #8b5cf6, #7c3aed)", border: "none", borderRadius: 8, color: "#fff", fontSize: 14, fontWeight: 700, cursor: "pointer" }}>
              Ir para Agentes
            </button>
          </Link>
        </div>
      ) : (
        <div style={{ background: "#080810", border: "1px solid rgba(139,92,246,0.10)", borderRadius: 16, overflow: "hidden" }}>
          {filtered.map((c, i) => (
            <Link key={c.id} href={`/app/conversations/${c.id}`}>
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 13, color: "#9992b8", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
