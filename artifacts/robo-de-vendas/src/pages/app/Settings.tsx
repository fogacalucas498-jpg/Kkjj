        ...
        <div style={{ background: "#080810", border: "1px solid rgba(139,92,246,0.10)", borderRadius: 16, padding: 32, marginBottom: 20 }}>
          ...
          <form onSubmit={handleSave}>
            <div style={{ marginBottom: 20 }}>
              <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#9992b8", marginBottom: 6 }}>Chave API OpenAI (sk-...)</label>
              <input
                type="password" value={apiKey} onChange={e => setApiKey(e.target.value)}
                placeholder="sk-proj-..."
                style={{ width: "100%", padding: "11px 14px", background: "#0e0e1a", border: "1px solid rgba(139,92,246,0.12)", borderRadius: 8, color: "#ffffff", fontSize: 14, outline: "none", boxSizing: "border-box" }}
              />
              <p style={{ fontSize: 12, color: "#9992b8", marginTop: 8 }}>
                Obtenha sua chave em <a href="https://platform.openai.com/api-keys" target="_blank" rel="noopener" style={{ color: "#8b5cf6" }}>platform.openai.com</a>. Sem custo adicional para o plano gratuito desta plataforma.
              </p>
            </div>
            <button type="submit" style={{ padding: "11px 28px", background: saved ? "rgba(139,92,246,0.2)" : "linear-gradient(135deg, #8b5cf6, #7c3aed)", border: saved ? "1px solid rgba(139,92,246,0.4)" : "none", borderRadius: 8, color: saved ? "#8b5cf6" : "#fff", fontSize: 14, fontWeight: 700, cursor: "pointer" }}>
